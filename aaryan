#!/bin/tcsh -f  
# Above line we need to write for letting system know, this is a script file.
...
echo "  **      **     **      **    "
echo
echo " a tcl script created by Aaryan Gupta(Software Engineer "
echo ""
...
if(! -f $argv[1] || $argv[1] == "-help") then #if arg is not a file or arg = "-help"
	if($argv[1] != "-help") then #if arg not "-help"
		...
		echo "USAGE: ./aaryan <csv file> , where the <csv file> consists of 2 columns  -->  1st column is being case sensitive."
